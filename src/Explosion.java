...
/**
 * This class represents the Explosion object that gets created whenever block gets destroyed or snake gets a token
...
public class Explosion extends Sprite implements Serializable {
	...
	/**
	 * destroy defines if this object can be destroyed.
	 * destroy_time_left defines the time left to destroy this object.
	 * This object gets destroyed after its explosion has been shown fully.
	 */
	private double destroy_time_left;
	
	/**
	 * In the constructor, we take screenCoordinates and pass it to the super class constructor.
	 * The constructor is private so that user cannot call it directly as there are certain properties that need to be defined according to which object has exploded
	...
	/**
	 * This overrides the intersects method of sprite class so that this object can never intersect with anything.
	 */
	@Override
	...
	/**
	 * This methods checks if the object can be destroyed or not based on the destroy time left.
	 ...
	 * @param screenCoordinates is an array of upper and lower bounds of the screen in XY plane. It is taken so that objects can know the boundaries of screen.
	 * @param time is the duration it takes for this explosion to complete
