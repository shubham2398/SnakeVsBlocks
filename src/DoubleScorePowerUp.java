...
/**
 * This represents the Double Score Power Up. This is a child of Sprite and
 * implements Tokenizable. It is also serializable. This power up makes the
 * score increase with double amount.
 * 
...
public class DoubleScorePowerUp extends Sprite implements Tokenizable, Serializable {
	...
	/**
	 * This defines the action method of Tokenizable interface such that snake's
	 * score can increase with double rate.
	 */
