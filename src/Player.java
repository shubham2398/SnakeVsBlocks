...
/**
 * This represents the player class that is used to save a player's name, score and date in leaderboard.
...
public class Player implements Serializable {
	...
	/**
	 * This contructor for Player makes a player taking values for name, score and date.
