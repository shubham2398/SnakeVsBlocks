...
/**
 * This class inherits Sprite class and is serializable. 
 * It represents a ball and defines all its properties and additional attributes.
...
public class Ball extends Sprite implements Serializable {
	...
	/**
	 * Set of points s1, s2, s3, s4, s5 represents the last 5 x coordinate states of the ball.
	 * These points are used to implement the smooth and wavy movement of balls.
	 */
	...
	/**
	 * This defines the abstract method update of Sprite class by giving functionality to it.
	 * It updates the position X such that the object never moves out of frame.
	 */
	@Override
	...
	/**
	 * This overrides the method of super class because here it needs to save previous states of X coordinate also
	 */
	@Override
