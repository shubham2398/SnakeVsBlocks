...
/**
 * This class represents a shield object.
 * This is a child of Sprite class and implements Tokenizable. It is also serializable.
 * This power up enables a snake to pass through any block without its length being decreased.
...
public class Shield extends Sprite implements Tokenizable, Serializable {
	...
	/**
	 * This method defines the abstract method update of Sprite class such that this can move only in Y direction.
	 */
	@Override
	...
	/**
	 * This method implements the action method of Tokenizable interface so that whenever this token and snake collide, the shield is activated for snake.
	 */
