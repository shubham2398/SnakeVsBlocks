...
/**
 * This is the class that represents a block. It is a child of Sprite and is serializable.
 * Snake cannot pass through a block unless it makes the value of that block to zero.
...
public class Block extends Sprite implements Serializable {
	...
	/**
	 * This method defines the abstract method update of Sprite class.
	 * It allows its movement only in Y direction.
	 */
	@Override
	...
	/**
	 * This method overrides the render method because we also want to display the number on the block along with its image.
	 */
	@Override
	...
	/**
	 * This method overrides the intersects method of block and changes it so that we check the tophalf boundary of s with the bottom boundary of the block
	 */
	@Override
	...
	/**
	 * This method collides the block and snake and decreases the length of the snake
	...
	/**
	 * This method checks if the block can be destroyed. This only check whether the number on block is 1 and it can be destroyed in one iteration.
	 * This method also decreases the length of the snake if the block can be destroyed by it.
	 * @param snake is the snake object with which block has collided
