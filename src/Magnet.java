...
/**
 * This class represents a Magnet.
 * It is a child of Sprite and implements Tokenizable interface. It is also Serializable.
 * It gives snake the ability to attract coins in a given radius
...
public class Magnet extends Sprite implements Tokenizable, Serializable {
	...
	/**
	 * This method defines the abstract update method of Sprite class such that this can only move in Y direction
	 */
	@Override
	...
	/**
	 * This method implements the action method of Tokenizable interface such that snake's magnet is activated when they collide
	 */
