...
/**
 * This is the class representing Destroy All Blocks Power Up. This is a child
 * of Sprite class and implements Tokenizable. It is also serializable. This
 * power up destroy all the blocks on the screen when it intersects with the
 * snake.
 * 
...
public class DestroyBlocksPowerUp extends Sprite implements Tokenizable, Serializable {
	...
	/**
	 * This defines the abstract method of Sprite class such that this is allowed to
	...
	/**
	 * This defines the action method of Tokenizable interface such that whenever
	 * snake intersects with it, all blocks can be destroyed.
	 */
