...
/**
 * This represents the coin object. It is a child of sprite and implements
 * Tokenizable interface. It is also serializable. Snake can collect coin when
 * they collide.
 * 
...
public class Coin extends Sprite implements Tokenizable, Serializable {
	...
	/**
	 * This defines the abstract method update of Sprite class such it is allowed to
	 * move in any direction in XY plane as it can be attracted by a magnet
	 */
	@Override
	...
	/**
	 * This defines the action method of Tokenizable interface so that we can add a
	 * coin to snake if snake collects coin
	 */
	@Override
