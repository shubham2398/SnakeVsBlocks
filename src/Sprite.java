...
public abstract class Sprite implements Serializable{
	...
	/**
	 * This is an abstract method that updates the position of the sprite according to its speed in the given time.
	 * It is made abstract as each sub class will implement its own way of updation.
	...
	/**
	 * This is the method that returns the boundary of the sprite.
	 * This can be used to detect collisions.
	...
	/**
	 * This method returns the left boundary of the sprite. 
	 * This can be used to detect left collisions.
	...
	/**
	 * This method returns the right boundary of the sprite.
	 * This can be used to detect right collisions.
	...
	/**
	 * This method returns the bottom boundary of the sprite.
	 * This can be used to detect collisions at bottom.
	...
	/**
	 * This method returns the top boundary of the sprite.
	 * This can be used to detect collision as top.
	...
	/**
	 * This method returns the boundary of the top half of sprite.
	 * This can be used to detect collision with a margin of half body.
	...
	/**
	 * This method checks whether this sprite intersects with another sprite s.
	 * To check this, it used the function intersects of Rectangle2D class and calls it on s , passing it's own boundary as an argument.  
	...
	/**
	 * This method checks whether this sprite's left boundary intersects with another sprite s.
	 * To check this, it used the function intersects of Rectangle2D class and calls it on s , passing it's own left boundary as an argument.  
	 * @param s is the sprite with which collision needs to be checked
	 * @return true if the sprite intersects with left boundary of this sprite , else returns false
	 */
	...
	/**
	 * This method checks whether this sprite's right boundary intersects with another sprite s.
	 * To check this, it used the function intersects of Rectangle2D class and calls it on s , passing it's own right boundary as an argument.  
	 * @param s is the sprite with which collision needs to be checked
	 * @return true if the sprite intersects with right boundary of this sprite , else returns false
	 */
	...
	/**
	 * This method checks whether this sprite's bottom boundary intersects with another sprite s.
	 * To check this, it used the function intersects of Rectangle2D class and calls it on s , passing it's own bottom boundary as an argument.  
	 * @param s is the sprite with which collision needs to be checked
	 * @return true if the sprite intersects with bottom boundary of this sprite , else returns false
	 */
	...
	/**
	 * This method checks whether the sprite has gone out of frame of screen by using screen coordinates.
	...
	/**
	 * The toString implementation of Sprite class which prints it's position and velocity
	 */
	...
	/**
	 * This method forces the given sprite s correctly so that if it is intersecting on left side, then it is left forced and if it is intersecting on right side, then it is right forced. 
	 * This is used so that the two sprites don't overlap on each other on collision.
